...
//                    
//                    selectedTimeArrayItems.append((contentDict.valueForKey("time") as! String))
...
//                if (timeDictionary["dose"] != nil) {
//                    
//                    valueForDoseForTime.append((timeDictionary["dose"] as! String))
//                } else {
                    valueForDoseForTime.append("")
//                }
            }
