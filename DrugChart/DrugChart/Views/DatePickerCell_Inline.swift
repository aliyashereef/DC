// DatePickerCellInline: display an inline date picker in a table view cell
...
*/
public class DatePickerCellInline: UITableViewCell {
    ...
    */
    ...
    /**
    Creates the DatePickerCellInline
    ...
    - returns: An initialized DatePickerCellInline object or nil if the object could not be created.
    */
...
//         The datePicker overhangs the view slightly to avoid invalid constraints.
    ...
    */
    ...
    /**
    Used to notify the DatePickerCellInline that it was selected. The DatePickerCellInline will then run its selection animation and expand or collapse.
    
    - parameter tableView: The tableview the DatePickerCellInline was selected in.
    */
